...
| | |
|---|---|
| Estimated cost | $0.5329 |
| Upper bound | $0.6061 |
| Protected cost | $0.6927 (buffer 30%) |
...
|---|---|---|---|
| #7 | 0.45 | change_kind, risk_class, evidence_overlap | $0.2821 |
...
- **repository_complexity** (raises) — complexity 1.53x against the reference repository
- **context_pressure** (raises) — severe pressure; relevant context did not fit the brief
...
- Context candidates: 12 sent of 34 available
- Context pressure: **severe** (2.83x)
