...
Same class as run 3, more to validate. Holds pricing class fixed so validation effort can be measured as its own variable rather than inferred from the assumed 0.15 share.

## Prediction

| | |
|---|---|
| Estimated cost | $0.3169 |
| Upper bound | $0.3589 |
| Protected cost | $0.4119 (buffer 30%) |
