# 0048 - Signature Business Brain view model and interaction

Status: Accepted

Date: 2026-08-24

Amended by [ADR 0049](0049-business-lens-diagnostic-scores.md), which adds
nullable evidence-grounded lens scores without changing this view-model boundary.

## Context

ADR 0047 made Business Health the project Home and allowed a bounded theatrical
...
This decision amends only the motion paragraph of ADR 0047. It changes no audit
