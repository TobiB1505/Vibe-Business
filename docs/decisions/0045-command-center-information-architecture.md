...
Status: Accepted; the rail's membership amended again by [0085](0085-nova-is-the-project-home.md) — Home becomes Nova and Business Health returns as its own destination, restoring the seven this ADR chose. *[2026-09-16: the navigation half is amended by [0109](0109-nova-first-application-shell.md) — the seven-row rail stops being the primary navigation and the project becomes Nova + Workspace; every address this ADR gave a section keeps resolving.]*
