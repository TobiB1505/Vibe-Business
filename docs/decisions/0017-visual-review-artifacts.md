...
Status: Accepted; superseded by [0065](0065-the-preview-is-the-review.md) in its role as a gate — the artifacts, their retention and their signed-URL rules stand for the rows that exist; the capture code it describes was deleted by [0075](0075-the-photograph-nobody-took.md) on 2026-09-02, once the last artifact had passed retention
Date: 2026-08-14
