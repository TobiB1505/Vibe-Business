...
- [0041](0041-billing-reconciliation-authority.md) — Billing Reconciliation Authority: one CAS-based authority model and one marker-based repair model closing drift repair, orphaned holds, stranded lot capacity and zero-credit settlement idempotency (Proposed; design only, no implementation)
