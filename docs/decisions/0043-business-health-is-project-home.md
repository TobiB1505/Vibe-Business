# 0043 - Business Health is the project Home
...
ADR 0041 gave the project workspace both a Home summary and a separate
...
This decision amends the seven-section navigation in ADR 0041. It changes no
