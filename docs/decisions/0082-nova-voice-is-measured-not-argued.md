...
Status: Accepted; extended by [0084](0084-nova-presentation-is-claimed-stored-and-attempted-once.md), which decides *when* a call may be made at all — this ADR chose the model and the prompt and left that open. Nothing measured here changes
Date: 2026-09-03
