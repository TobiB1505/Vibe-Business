...
Status: Accepted; amended 2026-09-02 — the projection could not complete the route it was written for, and the execution router did not read it; amended by [0077](0077-build-chains.md) — one execution may complete several steps
Date: 2026-08-26
