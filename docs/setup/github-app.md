...
- **Homepage URL**: your production custom domain (e.g. `https://your-production-domain.com`) — the same value `NEXT_PUBLIC_APP_URL` is set to in Vercel's Production environment, see [environment.md](../deployment/environment.md)
- **Callback URL**: `https://your-production-domain.com/app/connect/github/callback`
