# Sprint 0171 — The rail that refetched itself

**Date:** 2026-09-07
**Decision:** [ADR 0106](../decisions/0106-the-rail-is-a-layout-per-area.md)
...
`ChevronsUpDownIcon` joins the generated set from Lucide's manifest ([ADR 0101](../decisions/0101-icon-paths-come-from-lucide-the-frame-stays-vibes.md)). A single chevron says "expand"; two say "pick", and this control changes what the row names.
