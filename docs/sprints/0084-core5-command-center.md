...
[ADR 0041](../decisions/0045-command-center-information-architecture.md) for the decision and the
...
[ADR 0041](../decisions/0045-command-center-information-architecture.md), its index row, and its
