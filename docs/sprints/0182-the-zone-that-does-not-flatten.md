# Sprint 0182 — The zone that does not flatten
...
Explain the open point from Sprint 0181, do it, then implement the danger zone in settings — deleting and disconnecting — with the design skills and some research first.
...
Sprint 0180 wrote that the delete section is *"not a coloured card: nothing else in this product marks destruction that way"*. It does now — the founder asked for the zone by name, and one marked region on both settings surfaces is a vocabulary rather than a one-off.
