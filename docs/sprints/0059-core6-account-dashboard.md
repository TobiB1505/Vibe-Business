...
[CORE-5](0058-core5-command-center.md) rebuilt the *project* workspace as a Command Center with a
...
See [ADR 0042](../decisions/0042-account-dashboard-and-context-swap.md) for the decisions. In
