# Sprint 0170 — The two rails that were one

**Date:** 2026-09-07
**Decision:** [ADR 0105](../decisions/0105-one-rail-that-unfolds.md)
...
And "Back to your product" pointed at `/app`, which since [ADR 0104](../decisions/0104-the-account-level-is-settings.md) is a resolver that redirects — so leaving Settings cost a server round trip before anything could paint. That is not a perception of a reload; it is one.
