# Sprint 0165 — The button gets a surface
...
Sprint 0164 settled *how many* buttons there are. This settles *what one looks like*: five treatments, researched from the registries, rendered against the same jobs, chosen at the picture. The founder picked 3.
