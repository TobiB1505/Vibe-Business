...
- [Sprint 11B — Human Approval](0011b-human-approval.md) — the first explicit human authorization object, bound to one exact reviewed commit (Implemented; browser E2E not possible without a test harness, real dogfood pending)
