...
- [Sprint 10B — Temporary Change Preview](0010b-temporary-preview.md) — a validated artifact restored into a temporary isolated runtime on a public-unlisted URL (10B-1 capture, 10B-2 runtime and 10B-3 UI complete, mutation-validated and deployed; **real dogfood blocked on sign-in to the SSO-protected branch deployment — sprint stays open**)
