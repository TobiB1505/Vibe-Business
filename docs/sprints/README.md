...
- [Sprint 11C — Safe Merge](0011c-safe-merge.md) — the first Vibe-authorized write to a repository's default branch: exact approval, fresh GitHub preflight, fast-forward only, no force, independent read-back (Implemented — 19 deliberate regressions, 18 killed and 1 honestly equivalent; migration deployment, browser E2E and the real dogfood still pending)
