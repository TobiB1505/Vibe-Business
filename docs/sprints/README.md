...
- [0009-first-execution](0009-first-execution.md) — execution safety core: preflight, premise revalidation, deterministic generator (Partially implemented — domain built and mutation-validated; persistence, workflow and UI not built)
