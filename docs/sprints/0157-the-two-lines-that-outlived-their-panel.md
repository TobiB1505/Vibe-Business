# Sprint 0157 — The two lines that outlived their panel
...
The two assurances — *Changes land on their own branch*, *Nothing merged without your approval* — were written for the left panel of a split screen, where the panel's job was to say something while the form did the work. Sprint 0156 deleted the panel and kept its content, moving both lines under the form.
