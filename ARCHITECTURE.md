...
| [0109](docs/decisions/0109-the-business-agent-is-the-orchestrator.md) | The Business Agent is the orchestrator: one durable tool-calling turn under Nova's name, a second bounded exception to rule 41, founder-pressed controls for every consequential action (Proposed; the provider seam is built and piloted offline, Seam A selected provisionally, the paid run outstanding) | §3.6, Web surface |
