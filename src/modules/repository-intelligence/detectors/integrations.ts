...
const SIGNAL_RULES: SignalRule[] = [
  ...
  { id: "render", name: "Render", category: "deployment", configPattern: /^render\.yaml$/i },
  {
    ...
    name: "Railway",
    category: "deployment",
    configPattern: /^railway\.(json|toml)$/i,
  },
  { id: "flyio", name: "Fly.io", category: "deployment", configPattern: /^fly\.toml$/i },
  {
    ...
    name: "Docker",
    category: "deployment",
    configPattern: /^(dockerfile|docker-compose(\.[\w-]+)?\.(yml|yaml))$/i,
  },
  ...
  },
  {
    ...
    configPattern: /^drizzle\.config\./i,
  },
  {
    id: "postgres",
    name: "PostgreSQL",
  ...
  // of the Supabase client.
  {
    ...
    name: "Supabase Auth",
    category: "auth",
    dependencies: ["@supabase/ssr", "@supabase/auth-helpers-nextjs", "@supabase/auth-ui-react"],
  },
  {
    id: "clerk",
    name: "Clerk",
    category: "auth",
    dependencies: ["@clerk/nextjs", "@clerk/clerk-react", "@clerk/backend"],
  },
  {
    id: "authjs",
  ...
  // Payments
  {
    ...
    manifestToken: "stripe",
  },
  {
    id: "paddle",
    name: "Paddle",
    category: "payments",
    dependencies: ["@paddle/paddle-js", "@paddle/paddle-node-sdk"],
  },
  {
    id: "lemonsqueezy",
    name: "Lemon Squeezy",
  ...
  },
  {
    ...
    name: "Plausible",
    category: "analytics",
    dependencies: ["next-plausible", "plausible-tracker"],
  },
  {
    id: "google_analytics",
    name: "Google Analytics",
    category: "analytics",
    dependencies: ["react-ga4", "@next/third-parties"],
  },
  {
    id: "vercel_analytics",
  ...
  // change nothing can verify (rule 78).
  {
    ...
    configPattern: /^vitest\.config\./i,
  },
  {
    id: "jest",
    name: "Jest",
    category: "testing",
    dependencies: ["jest", "ts-jest", "@jest/globals", "babel-jest"],
    configPattern: /^jest\.config\./i,
  },
  {
    id: "playwright",
    name: "Playwright",
    ...
    configPattern: /^playwright\.config\./i,
  },
  {
    id: "cypress",
    name: "Cypress",
    ...
    configPattern: /^cypress\.config\./i,
  },
  {
    id: "mocha",
    name: "Mocha",
  ...
  { id: "jenkins", name: "Jenkins", category: "ci", configPattern: /^jenkinsfile$/i },
  {
    ...
    category: "ci",
    configPattern: /^azure-pipelines\.ya?ml$/i,
  },
  { id: "travis_ci", name: "Travis CI", category: "ci", configPattern: /^\.travis\.ya?ml$/i },
  {
    ...
    category: "ci",
    configPattern: /^bitbucket-pipelines\.ya?ml$/i,
  },
  { id: "drone_ci", name: "Drone CI", category: "ci", configPattern: /^\.drone\.ya?ml$/i },
  {
    ...
    name: "Woodpecker CI",
    category: "ci",
    configPattern: /^\.woodpecker\.ya?ml$/i,
  },
  ...
  { id: "resend", name: "Resend", category: "email", dependencies: ["resend"] },
  {
    ...
    name: "SendGrid",
    category: "email",
    dependencies: ["@sendgrid/mail", "@sendgrid/client"],
    manifestToken: "sendgrid",
  },
  ...
  { id: "mailgun", name: "Mailgun", category: "email", dependencies: ["mailgun.js", "mailgun-js"] },
  {
    ...
    name: "Amazon SES",
    category: "email",
    dependencies: ["@aws-sdk/client-ses", "@aws-sdk/client-sesv2"],
  },
  {
    id: "react_email",
    name: "React Email",
    category: "email",
    dependencies: ["react-email", "@react-email/components"],
  },
  ...
  },
  {
    ...
    name: "Vercel Flags",
    category: "feature_flags",
    dependencies: ["flags", "@vercel/flags"],
  },
  {
    id: "flagsmith",
    name: "Flagsmith",
    category: "feature_flags",
    dependencies: ["flagsmith", "flagsmith-nodejs"],
  },
  {
    id: "unleash",
    name: "Unleash",
  ...
  },
  {
    ...
    name: "Statsig",
    category: "feature_flags",
    dependencies: ["statsig-js", "statsig-node"],
  },
  {
    id: "split_io",
    name: "Split",
    category: "feature_flags",
    dependencies: ["@splitsoftware/splitio", "@splitsoftware/splitio-react"],
  },
  {
    id: "configcat",
    name: "ConfigCat",
    category: "feature_flags",
    dependencies: ["configcat-js", "configcat-node"],
  },
  {
    id: "growthbook",
    name: "GrowthBook",
    category: "feature_flags",
    dependencies: ["@growthbook/growthbook", "@growthbook/growthbook-react"],
  },
  ...
  // Monitoring
  {
    ...
    name: "Sentry",
    category: "monitoring",
    dependencies: ["@sentry/nextjs", "@sentry/node", "@sentry/react", "@sentry/browser"],
    manifestToken: "sentry-sdk",
  },
];
 ...
 */
export const INTEGRATION_CATEGORY_BY_ID: Readonly<Record<string, SignalCategory>> = Object.freeze(
