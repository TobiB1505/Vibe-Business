  ...
  return [
    ...
    ...(completion
      ? [
          ...
          "",
          "Change as many files as the step genuinely needs — breadth costs you nothing here, and",
          "while you are still writing, reading whatever you need to write the next file is free.",
          "",
          `Once you stop changing files, you have about ${completion.maxCompletionActions} more tool actions for this step,`,
          `of which at most ${completion.maxOutsideBriefReads} may read a file outside the ones named above. Re-reading the`,
          "files you changed, to check what you wrote, is always available and is not counted",
          "against that — Vibe asked you to review your own diff, so Vibe does not then refuse it.",
          "",
