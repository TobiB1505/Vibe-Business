...
provider.ts            AIProvider — domain-owned, no Anthropic types — and, beside it,
                       AIToolCallingProvider: one tool-calling turn (ADR 0109, Accepted)
