 ...
 * uninteresting — it is the one that is supposed to cost money. What ADR 0086
...
describe("a read resolves an identity and never spends", () => {
  ...
  /**
   * The structural half of ADR 0086's fifth condition. A render cannot reach a
   ...
   * again. That is the trade ADR 0086 makes on purpose: the failure mode of
