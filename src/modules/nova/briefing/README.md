...
Built, and deliberately without a model. No surface in this product tells a founder where they _stand_ — the audit screen shows the audit, the plan screen shows the plan, My Product shows the scan, and nothing says "given all of it, here is the situation". That is a gap in the reading rather than in the writing: the facts have never been gathered.

`briefing.ts` gathers them. Who the founder is and what they asked to be called, what they said they want, every link of the evidence chain with how old it is, the one thing open now, the Move the engine ranked first, and what Vibe's own rules say to repair before the rest is worth doing.
