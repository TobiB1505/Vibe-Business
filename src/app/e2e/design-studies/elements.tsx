...
/**
 * The bubble is `NovaBubble`, and the lab draws the product's one.
 *
 * It was written here, and moved to `src/components/nova/nova-bubble.tsx` when
 * Home began rendering it. Re-exported under the name the studies already use
 * so every sheet keeps reading the way it reads, and so there is no second
 * bubble to keep in step with the first.
 */
