...
export default function HomePage() {
  return (
    <>
      {/* Structured data (schema.org `WebApplication`) so a search engine
          describes the product from the application's own metadata, not
          from whatever text it happens to scrape — see `product-jsonld.ts`. */}
      <script
        type="application/ld+json"
        // eslint-disable-next-line react/no-danger -- static, non-interactive JSON, not user input
