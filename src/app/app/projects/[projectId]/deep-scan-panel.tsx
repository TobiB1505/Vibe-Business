      ...
      >
        ...
        */}
        ...
        {!busy && signIn.startsInSeconds !== null && (
           ...
           * say so.
           */
          <div role="status" className="space-y-2 rounded-inset border border-line-2 bg-surface-2 p-3">
            <p className="text-body text-fg-prose">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Button variant="ghost" type="button" onClick={onCancel} disabled={busy} className="text-body">
            Cancel
          </Button>
        </div>
      </div>
          ...
          */}
          ...
          <ul className="flex flex-col gap-1.5">
            {result.screens.map((screen) => (
              ...
              >
                <span className="text-fg-prose text-body">
