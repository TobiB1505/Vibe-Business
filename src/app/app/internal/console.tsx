    ...
    <main className="mx-auto max-w-[1180px] px-8 py-10">
      ...
      >
        {snapshot.consistency.findings.length === 0 ? (
          <p className="font-mono text-caption text-mint">nothing disagrees</p>
        ) : (
          <Rows
        ...
        {snapshot.consistency.acknowledged.length > 0 && (
          <div className="mt-3 border-t border-line-1 pt-2">
            <p className="mb-1.5 font-mono text-caption text-fg-meta">
        ...
        <p className="mt-3 font-mono text-caption text-fg-faint">
